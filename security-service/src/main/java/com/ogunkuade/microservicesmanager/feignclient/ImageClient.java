...
//USER IMAGE
    ...
    UserImageResponseDto imageUserRestUploading(@RequestBody ImageRequest imageRequest, @PathVariable Long id) ;


    //GET SINGLE IMAGE BY ID
    @GetMapping("/user-image/{id}")
    UserImageResponseDto gettingUserRestImage(@PathVariable Long id);


    //GET SINGLE IMAGE BY USER ID
    @GetMapping("/user-image/userId/{id}")
    UserImageResponseDto gettingUserRestImageByUserId(@PathVariable Long id);


    //GET ALL IMAGES
    @GetMapping("/user-image/all")
    List<UserImageResponseDto> gettingAllUserRestImage();
