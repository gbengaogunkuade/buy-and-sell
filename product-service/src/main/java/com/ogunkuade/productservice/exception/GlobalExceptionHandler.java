...
public class GlobalExceptionHandler {
    ...
    //_______EXCEPTION HANDLER FOR ProductNotFoundException_________
    ...
    public ResponseEntity<ExceptionResponse> handleProductNotFoundException(ProductNotFoundException productNotFoundException){
        ExceptionResponse exceptionResponse = new ExceptionResponse(new Date(), "PRODUCT NOT FOUND", productNotFoundException.getMessage());
